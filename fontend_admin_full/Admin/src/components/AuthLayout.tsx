...
const AuthLayout = ({
  ...
  return (
    <>
      <div className="relative bg-gradient-to-r from-rose-100 to-teal-100 dark:from-gray-700 dark:via-gray-900 dark:to-black">
        <div className="h-screen w-screen flex justify-center items-center">
          ...
          <div className="2xl:w-1/4 lg:w-1/3 md:w-1/2 w-full absolute z-10">
              ...
              <div className="p-6">
                {userImage ? (
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-4 mb-6">
                      <Link to="/" className="block">
                        <img className="h-10 block dark:hidden" src={logoDark} />
                        <img className="h-10 hidden dark:block" src={logoLight} />
                      </Link>
                  ...
                  <Link to="/" className="block mb-8">
                    <img className="h-10 block dark:hidden" src={logoDark} alt="" />
                    <img className="h-10 hidden dark:block" src={logoLight} alt="" />
                  </Link>
                )}
