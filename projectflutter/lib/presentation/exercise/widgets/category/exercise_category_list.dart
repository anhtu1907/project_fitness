        ...
        builder: (context, state) {
          ...
          if (state is SubCategoryLoaded) {
            ...
            for (var category in subCategoryList) {
              for (var cat in category.category) {
                ...
                if (state is ExercisesLoaded) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final subCategoryId = entry.value.first.id;
                      final matchedExercise = exerciseList.cast<ExercisesEntity?>().firstWhere(
                            (exercise) => exercise!.subCategory.any((sub) => sub.id == subCategoryId),
                        orElse: () => null,
                      );

                      final level = matchedExercise!.mode!.modeName;
