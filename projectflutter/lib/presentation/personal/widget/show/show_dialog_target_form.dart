...
import 'package:projectflutter/domain/bmi/usecase/update_goal_usecase.dart';

class ShowDialogTargetForm extends StatefulWidget {
  final double weight;
  final String title;
  const ShowDialogTargetForm(
      {super.key, required this.weight, required this.title});

  @override
  State<ShowDialogTargetForm> createState() => _ShowDialogTargetFormState();
}

class _ShowDialogTargetFormState extends State<ShowDialogTargetForm> {
